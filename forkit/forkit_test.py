...
class ForkitTest(unittest.TestCase):
    ...
    def test_fork_repo(self):
        ...
        # It's a fair assumption to be made that this test should suffice to
        # cover both cases. Another deciding factor is that is that in order to
        # reset the user's state on Github, ie delete any repositories
        # generated by testing, requires more permissions.
